...
model.save('/data/trainingdata/simpsons_weights6_0724.h5')

pandas.DataFrame(simpsonsModel.history).to_json("/data/trainingdata/simpsons_history_0724.json")
...
pyplot.savefig('simpsons_predict_0626_2.png')